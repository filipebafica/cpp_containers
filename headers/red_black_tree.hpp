...
class red_black_tree {
 public:
    ...
    ft::rb_node<RB_NODE_TYPES> *search_rb_node(const key_type& key) const;
 ...
 private:
   ...
   ft::rb_node<RB_NODE_TYPES> *search_rb_node_aux(ft::rb_node<RB_NODE_TYPES> *x, const key_type& key) const;
