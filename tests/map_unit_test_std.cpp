...
void swap_method_test(void)
{
    ...
    for (int i = 0; i < 10; i++)
    {
        x.insert(std::pair<int, int>(i, i));
    }

    for (int i = 100; i < 105; i++)
    {
        y.insert(std::pair<int, int>(i, i));
    }
...
void lower_upper_bound_method_test(void)
{
    std::cout << std::endl << "[LOWER BOUND METHOD TEST]" << std::endl;
    {
        ...
        for (int i = 0; i < 10; i++)
        {
            map_1.insert(std::pair<int, int>(i, i));
        }
...
void end_method_test(void)
{
    ...
    const std::map<int, int> map_2(map_1.begin(), map_1.end());
...
void insert_method_test(void)
{
    std::cout << std::endl << "[INSERT METHOD TEST]" << std::endl;
    {
        ...
        map_1.insert(std::pair<int, int>(10, 10));
...

    {
        ...
        map_1.insert(map_1.begin(), std::pair<int, int>(10, 10));
