...
void swap_method_test(void) {
    ...
    ft::vector<int> v0_a(5, 1);
    ft::vector<int> v0_b(5, 2);
    std::cout << "before v0_a.swap(v0_b):" << std::endl;
    std::cout << "v0_a: ";
    for (ft::vector<int>::iterator it = v0_a.begin(); it != v0_a.end(); it++)
        std::cout << *it << " ";
    std::cout << std::endl;
    std::cout << "v0_b: ";
    for (ft::vector<int>::iterator it = v0_b.begin(); it != v0_b.end(); it++)
        std::cout << *it << " ";
    std::cout << std::endl;
    v0_a.swap(v0_b);
